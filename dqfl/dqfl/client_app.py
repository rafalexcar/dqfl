...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        return (
            ...
            len(self.trainloader.dataset), # give more weight for bigger datasets
...
def client_fn(context: Context):
    ...
    trainloader, valloader = load_data(partition_id, num_partitions) #num_partitions = clients in total
